function [pE,pC,D,is_logscale] = spm_hdm_priors_hdm6(m,M)

% Same as spm_hdm_priors_hdm2 in toolbox, but other versions
% spm_hdm_priors_hdm4/6 have additional parameters switched on, ie pC>0
