function [t,F,p,df,R2,cR2,B,r,aR2,iR2,Bcov] = glm(y,X,c,pflag);
...
cE = diag(diag(r*r')); % too inefficient to estimate without ReML...
%cE = eye(length(r)); % if assumed to be white anyway!
Bcov = pinv(X)*cE*pinv(X)';
